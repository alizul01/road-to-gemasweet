...
public class Test {
    ...
    public static boolean isPerpendicularIntersection(int[] ironmanPos, int[] ultronPos, int[] obs) {
        if ((obs[0] < ironmanPos[0] && obs[0] > ultronPos[0]) || (obs[1] < ironmanPos[1] && obs[1] > ironmanPos[1])) {
            return true;
        } else {
            return false;
        }
